	...
	border_(border)
{
	if (!validFormat(format)) {
		throw GraphicsException("Invalid format supplied to Texture constructor");
	}
	if (!validInternalFormat(internalFormat)) {
		throw GraphicsException("Invalid internal format supplied to Texture constructor");
	}
	if (!validType(type)) {
		throw GraphicsException("Invalid type supplied to Texture constructor");
	}
