...
VertexBuffer::VertexBuffer(const std::vector<vec4> &v, GLenum usage)
	:BufferObject(v.size()*sizeof(vec4), usage, v.data())
{}

VertexBuffer::VertexBuffer(const std::vector<vec3> &v, GLenum usage)
	:BufferObject(v.size()*sizeof(vec3), usage, v.data())
{}

VertexBuffer::VertexBuffer(const std::vector<vec2> &v, GLenum usage)
	:BufferObject(v.size()*sizeof(vec2), usage, v.data())
{}
