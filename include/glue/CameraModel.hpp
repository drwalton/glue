#ifndef GLUE_CAMERAMODEL_HPP_INCLUDED
#define GLUE_CAMERAMODEL_HPP_INCLUDED
...
enum class CameraModelType { PINHOLE };

//!\brief Abstract class encapsulating a model for a camera, capable of 
//!       associating pixel locations with directions (and vice versa).
class CameraModel {
public:
