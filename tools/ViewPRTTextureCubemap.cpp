...
int main(int argc, char *argv[])	
{
	...
	cubemapSHPlot.modelToWorld(glue::translateMat4(glue::vec3(2.f, 0.f, 0.f)));
...
//	for(size_t i = 0; i < 6; ++i) {
//		glGetTexImage(GL_TEXTURE_CUBE_MAP_POSITIVE_X + i, 0, GL_BGR, GL_UNSIGNED_BYTE, cubemapImages[i].data);
//		cv::imshow("cubemapims", cubemapImages[i]);
//		cv::waitKey();
//	}
	...
	assert(prtCoefftArrTex.nLayers() == 16); //Must have 4 bands of PRT!
