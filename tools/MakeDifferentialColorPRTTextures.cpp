...
int main(int argc, char *argv[])
{
	...
	glue::PrtCoeffts<glue::vec3> prtA = glue::loadUncompressedPrtCoeffts<glue::vec3>(texAFilename);
	glue::PrtCoeffts<glue::vec3> prtB = glue::loadUncompressedPrtCoeffts<glue::vec3>(texBFilename);
